...
const cardClass =
  "flex flex-col rounded-2xl border border-gridline bg-card px-6 py-7 shadow-[0_1px_0_rgba(44,62,53,0.04)] md:px-8 md:py-9";
  ...
  return (
    <>
      <section>
        ...
        <div className="mt-8 overflow-hidden rounded-2xl border border-gridline">
      ...
      <section>
        ...
        <dl className="mt-8 space-y-3 md:space-y-0 md:divide-y md:divide-gridline md:border-y md:border-gridline">
          {entry.team.map(([k, v]) => (
            <div
              key={k}
              className="flex flex-col gap-1.5 rounded-2xl border border-gridline bg-card px-5 py-4 md:flex-row md:items-baseline md:gap-10 md:rounded-none md:border-0 md:bg-transparent md:px-0 md:py-5"
            >
